<template>
  <HeroImage img-src="/resume.jpg" image-align="bottom" />
  <ContentArticle>
        <h3>Resumé</h3>
        ...
        <Carousel>
          <CarouselSlide>
            ...
            <p>
              ...
              component-based architecture and design systems engineering. Technical leader, team builder and program
              manager with well-rounded skills covering the complete software engineering lifecycle.
            </p>
            ...
            <ul>
              ...
              <li>
                <a href="https://www.tenable.com/products/tenable-io" target="_blank" rel="noreferrer">Tenable.io</a> -
                Built dashboard and reporting software with React/Redux for ground-up redesign and rebuild of application.
                Helped establish design system for cross-product consistency and developer productivity
              </li>
              ...
              <li>
                <a href="http://www.apptio.com/applications/it-planning" target="_blank" rel="noreferrer">Apptio IT Planning Foundation</a> -
                Drove prototype development during design phase, frontend engineer during implementation of finished designs
              </li>
          ...
          <CarouselSlide>
            ...
            <dl>
              ...
              <dd>
                <p>
                  Led a small team in delivery of new features and core functionality for Tenable.io SaaS product, and
                  Tenable.sc scrum team that worked on future major version release.
                </p>
                <ul>
              ...
              <dt>April 2015 - May 2016</dt>
              <dd>Senior Software Engineer</dd>
              <dd>Tenable</dd>
              <dd>
                <p>
                  Wrote frontend JavaScript with ES6 syntax, HTML5 and Less/CSS3 programming for Nessus and Nessus Cloud
          ...
          <CarouselSlide>
            ...
            <dl>
              ...
              <dd>
                <p>
                  Implemented functional prototype based on sketches, wireframes and visual designs; produced HTML5, CSS3
                  and JavaScript code for product.
                </p>
                <ul>
              ...
              <dt>June 2006 - October 2013</dt>
              <dd>Development Manager</dd>
              <dd>Sabre Hospitality Solutions</dd>
              <dd>
                <p>
                  Managed internal and external clients throughout project lifecycles. Worked as Lead Developer, Supervisor
                  and member of the company Innovation Team.
                </p>
                <ul>
          ...
          <CarouselSlide>
            ...
            <dl>
              ...
              <dd>
                <p>
                  Responsible for overall design execution of all website projects and established a website framework that
                  dramatically increased efficiency and standardized the codebase.
                </p>
                <ul>
              ...
              <dt>June 2003 - January 2005</dt>
              <dd>Web Developer</dd>
              <dd>E-site Marketing</dd>
              <dd>
                <p>
                  Delivered high quality code for exceptionally fast-paced business under tight deadlines. Learned to develop,
                  validate and process forms as well as other basic website maintenance.
                </p>
                <ul>
          ...
          <CarouselSlide>
            ...
            <p>
              <i>
                References will be provided upon request. Additional URLs, demos and code samples can also be made available.
                Please <RouterLink to="/contact">contact</RouterLink> for more information.
              </i>
            </p>
            <p>
              <i>
